        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center gap-4">
            ...
            <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer"
              className="hidden lg:flex flex-shrink-0 items-center gap-2 rounded-lg bg-green-600 hover:bg-green-500 px-4 py-2 text-sm font-bold text-white transition-colors">
              <WAMd /> Fale Conosco
            </a>
          </div>
        </div>
