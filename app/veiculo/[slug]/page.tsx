            ...
            <div className="grid gap-6 lg:gap-8 lg:grid-cols-2">
              ...
              <div>
                ...
                <div className="rounded-xl border-2 border-primary/20 bg-primary/5 p-5 mb-5">
                  ...
                  <p className="text-2xl sm:text-3xl font-bold text-foreground">R$ {veiculo.preco.toLocaleString("pt-BR")}</p>
                ...
                <div className="flex flex-col gap-3">
                  <Button asChild size="lg" className="w-full bg-secondary hover:bg-secondary/90 text-secondary-foreground font-bold gap-2 py-4 sm:py-6">
